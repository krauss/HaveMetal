...
var AddDuctPage = /** @class */ (function () {
    ...
    AddDuctPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-add-duct',template:/*ion-inline-start:"/home/jrkrauss/workspaces/ionic/HaveMetal_Angular/src/pages/add-duct/add-duct.html"*/'<!--\n  Generated template for the AddDuctPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>Add New Duct</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <ion-item required>\n    <ion-label>Type</ion-label>\n      <!--<ion-select [(ngModel)]="type" (ionChange)="selectDuctType($event)">-->\n          <ion-select [(ngModel)]="type">\n          <ion-option *ngFor="let type of type_list">{{type}}</ion-option>\n      </ion-select>\n  </ion-item> \n\n  <ion-item required>\n    <ion-label>Quantity</ion-label>\n    <ion-input type="number" [(ngModel)]="qty"></ion-input>\n  </ion-item>\n    \n  <button margin-top ion-button block clear color="primary" (click)="addDuct(type)">Add</button>\n  \n  <button ion-button block clear color="secondary" (click)="cancel()">Cancel</button>\n\n</ion-content>\n'/*ion-inline-end:"/home/jrkrauss/workspaces/ionic/HaveMetal_Angular/src/pages/add-duct/add-duct.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__models_services_firebase_service__["a" /* JobListService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ToastController */]])
    ], AddDuctPage);
    return AddDuctPage;
}());
