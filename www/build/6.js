...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__job_edit__ = __webpack_require__(648);
...
var JobEditPage = /** @class */ (function () {
    ...
    JobEditPage.prototype.updateJob = function (jobe) {
        var _this = this;
        //Update Item
    ...
    JobEditPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-job-edit',template:/*ion-inline-start:"/home/jrkrauss/workspaces/ionic/HaveMetal_Angular/src/pages/job-edit/job-edit.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{job.name}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <ion-list padding>\n\n    <ion-item>\n      <ion-label floating>Job Name</ion-label>\n      <ion-input type="text" [(ngModel)]="job.name"></ion-input>\n    </ion-item>\n\n    <ion-item>\n      <ion-label floating>Site Address</ion-label>\n      <ion-input type="text" [(ngModel)]="job.address"></ion-input>\n    </ion-item>\n\n  </ion-list>\n\n  <div padding>\n    <button ion-button clear block color="light" (click)="updateJob(job)">Save</button>\n  </div>\n\n</ion-content>\n'/*ion-inline-end:"/home/jrkrauss/workspaces/ionic/HaveMetal_Angular/src/pages/job-edit/job-edit.html"*/,
        }),
