...
var DuctListPage = /** @class */ (function () {
    function DuctListPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.duct_list = [];
        this.job_key = this.navParams.get('job_key');
    }
    DuctListPage.prototype.addDuctList = function () {
        this.navCtrl.push('AddDuctPage', { job_key: this.job_key });
    };
    DuctListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-duct-list',template:/*ion-inline-start:"/home/jrkrauss/workspaces/ionic/HaveMetal_Angular/src/pages/duct-list/duct-list.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <ion-title text-center>Duct List</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="addDuctList()">\n        <ion-icon name="add"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>'/*ion-inline-end:"/home/jrkrauss/workspaces/ionic/HaveMetal_Angular/src/pages/duct-list/duct-list.html"*/,
        }),
