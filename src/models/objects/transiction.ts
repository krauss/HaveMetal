...
export class Transiction extends Duct {
  ...
  draw(): void {
    ...
    this._geometry.vertices.push(
      ...
      new THREE.Vector3( 0, 1, this._length ), //Vertex 2
      ...
      new THREE.Vector3( this._width - 2, this._height, this._length ), //Vertex 6
      new THREE.Vector3( this._width - 2, 1, this._length ) //Vertex 7
    );
